...
my_name = "Revan" # Change to your name
my_github_account = "https://github.com/ManVanIran" # Change to your GitHub account
my_hobby = "watching movies and shows" # Change to your hobby
hours_coding_per_week = "7" # How many hours per week would you like to devote to learn coding?
...
The main projects I'd like to do in this term are: {project_interested} and {project_another_interested}, but the other 2 are really fun too and I am very interested in doing them as well.
